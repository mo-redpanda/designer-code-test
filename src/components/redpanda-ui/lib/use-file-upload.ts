...
export const useFileUpload = (options: FileUploadOptions = {}): [FileUploadState, FileUploadActions] => {
  ...
  const validateFile = useCallback(
    // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: part of file upload implementation
  ...
  const addFiles = useCallback(
    (newFiles: FileList | File[]) => {
      ...
      // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: part of useFileUpload hook implementation
