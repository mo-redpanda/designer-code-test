...
function AlertDialog({
  testId,
  ...props
}: React.ComponentProps<typeof AlertDialogPrimitive.Root> & { testId?: string }) {
...
function AlertDialogTrigger({
  testId,
  ...props
}: React.ComponentProps<typeof AlertDialogPrimitive.Trigger> & { testId?: string }) {
  return <AlertDialogPrimitive.Trigger data-slot="alert-dialog-trigger" data-testid={testId} {...props} />;
}
...
function AlertDialogContent({
  ...
  testId,
  ...props
}: React.ComponentProps<typeof AlertDialogPrimitive.Content> & { testId?: string }) {
  return (
    <AlertDialogPortal>
      <AlertDialogOverlay />
