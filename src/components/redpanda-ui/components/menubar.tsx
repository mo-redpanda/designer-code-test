...
function Menubar({
  ...
  testId,
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.Root> & { testId?: string }) {
  return (
...
function MenubarTrigger({
  ...
  testId,
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.Trigger> & { testId?: string }) {
  return (
...
function MenubarContent({
  ...
  testId,
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.Content> & { testId?: string }) {
  return (
    <MenubarPortal>
