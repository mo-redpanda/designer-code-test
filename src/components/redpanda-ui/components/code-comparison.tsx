...
export function CodeComparison({
  ...
  const renderCode = (code: string, highlighted: string) => {
    if (highlighted) {
      return (
        <div
          ...
          // biome-ignore lint/security/noDangerouslySetInnerHtml: part of code comparison implementation
    ...
    return (
      <pre className="h-full overflow-auto break-all bg-background p-4 font-mono text-xs text-foreground [&_*::selection]:bg-primary [&_*::selection]:text-primary-foreground">
        {code}
      </pre>
    );
  };
  ...
  return (
    <div className="mx-auto w-full max-w-5xl" data-testid={testId}>
